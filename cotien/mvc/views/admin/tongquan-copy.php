                    ...
                    <div class="col mt-md-0 mt-2">
                        <div class="p-3 d-flex align-items-center metric-card h-100 bg-white shadow-sm">
                            ...
                            <div class="flex-grow-1 text-center">
                                <div class="fw-bold">25,000,000<br>VND
                                </div>
                                <small class="text-muted d-block mt-1 text-secondary">Tổng đầu tư</small>
                            </div>
                            <div>
                                <span class="metric-change up ms-2 " style="color: #17c964;">
                    ...
                    <!-- Card 2 -->
                     <div class="col mt-md-0 mt-2">
                        <div class="p-3 d-flex align-items-center metric-card h-100 bg-white shadow-sm">
                            ...
                            <div class="flex-grow-1 text-center">
                                <div class="fw-bold">3,750,000<br>VND
                                </div>
                    ...
                    <!-- Card 2 -->
                     <div class="col mt-md-0 mt-2">
                        <div class="p-3 d-flex align-items-center metric-card h-100 bg-white shadow-sm">
                            ...
                            <div class="flex-grow-1 text-center">
                                <div class="fw-bold">12,500,000<br>VND
                                </div>
