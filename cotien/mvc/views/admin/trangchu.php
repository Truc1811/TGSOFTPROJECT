...
<div class="row text-center justify-content-center d-flex d-md-none mt-3 ps-1 pe-1">
            <div class="col-3">
...
<div class="row justify-content-center d-flex d-md-none ps-3 pe-3 ">
                    ...
                    <div class="scroll-item-2">
                        <div class="card position-relative overflow-hidden h-100">
                            <a href="danhsachtaisan/dsts/55" class="stretched-link text-decoration-none">
                                ...
                                <img src="public/upload/<?= $value_trang_chu_noi_dung_so_1_1_mobile[0] ?>" class="w-100 card-img-top " alt="Ảnh Moble">
                            </a>
                        </div>
                    </div>
                <?php } ?>
            ...
            <div class="scrolling-wrapper luot_cha">
                <?php foreach ($toi_uu_code_noi_dung_so_1_2__MOBILE as $key => $value_trang_chu_noi_dung_so_1_2_mobile) { ?>
                    <div class="scroll-item-2">
                        <div class="card position-relative overflow-hidden h-100">
                            <a href="danhsachtaisan/dsts/55" class="stretched-link text-decoration-none">
                                <img src="<?php echo $value_trang_chu_noi_dung_so_1_2_mobile[0]; ?>" class="w-100 card-img-top " alt="Ảnh" />
    ...
    <div class="row g-4">
      ...
      <div class="col-md-3">
        <div class="bg-white text-dark p-4 rounded-4 shadow">
          <img src="https://scontent.fhan4-3.fna.fbcdn.net/v/t39.30808-6/514175332_122229543794190020_6355200716836002328_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=127cfc&_nc_ohc=l-hBeH_UwT0Q7kNvwHtwAUc&_nc_oc=AdloV8OqP1-sJNfRWkBVxP1UHkIaMGczcpVf9px-t-NYq93Dy07llmPiScqPYoVvAPc&_nc_zt=23&_nc_ht=scontent.fhan4-3.fna&_nc_gid=QiluWyghceZ2nqGvWekvzQ&oh=00_AfR_TqrC4xopHBX0w1TBlJnYsYpEVBQIczu47MTowAu13A&oe=687A8C21" alt="" class="w-100 img-fluid" style="height: 246px;">
