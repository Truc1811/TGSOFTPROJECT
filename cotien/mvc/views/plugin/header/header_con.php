				...
				<!-- aa1 -->
					...
					<div class="col p-2 theten cursor">
						<a class="text-decoration-none text-black chu-cbold" href="">
							<div class="card border-0">
								<div class="mb-3">
									<img class="w-100" src="public/demo/portrait_uncanny (1).jpg">
								</div>
								<div class="card-body p-0">
									<h6 class="fw-bold">FREE COMIC BOOK DAY 2025: AMAZING SPIDER-MAN/ULTIMATE UNIVERSE (2025) #1</h6>
								</div>
					...
					<div class="col p-2 theten cursor">
						<a class="text-decoration-none text-black chu-cbold" href="">
							<div class="card border-0">
								<div class="mb-3">
									<img class="w-100" src="public/demo/portrait_uncanny (2).jpg">
								</div>
								<div class="card-body p-0">
									<h6 class="fw-bold">FREE COMIC BOOK DAY 2025: AMAZING SPIDER-MAN/ULTIMATE UNIVERSE (2025) #1</h6>
								</div>
					...
					<div class="col p-2 theten cursor">
						<a class="text-decoration-none text-black chu-cbold" href="">
							<div class="card border-0">
								<div class="mb-3">
									<img class="w-100" src="public/demo/portrait_uncanny (3).jpg">
								</div>
								<div class="card-body p-0">
									<h6 class="fw-bold">FREE COMIC BOOK DAY 2025: AMAZING SPIDER-MAN/ULTIMATE UNIVERSE (2025) #1</h6>
								</div>
					...
					<div class="col p-2 theten cursor">
						<a class="text-decoration-none text-black chu-cbold" href="">
							<div class="card border-0">
								<div class="mb-3">
									<img class="w-100" src="public/demo/portrait_uncanny (4).jpg">
								</div>
								<div class="card-body p-0">
									<h6 class="fw-bold">FREE COMIC BOOK DAY 2025: AMAZING SPIDER-MAN/ULTIMATE UNIVERSE (2025) #1</h6>
								</div>
