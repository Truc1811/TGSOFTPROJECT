                ...
                <div class="col-12 d-flex flex-wrap p-2">
                    <div class="col-12 bg-white rounded-3 d-flex flex-wrap">
                        ...
                        <div class="col-12 col-md-6 px-3 pb-3">
                            ...
                            <input type="text" name="so_chung_tu" required="required" class="form-control form-control-sm" id="inputEmail4">
                        </div> 
                        <div class="col-12 col-md-6 px-3 pb-3">
                            <label for="inputEmail4" class="form-label" >Tổng tiền</label>
                            <input type="text" name="tong_tien" required="required" class="form-control form-control-sm" id="inputEmail4">
                        </div> 
                        <div class="col-12 col-md-6 px-3 pb-3">
                            <label for="inputEmail4" class="form-label" >Số hóa đơn</label>
                            <input type="text" name="so_hoa_don" required="required" class="form-control form-control-sm" id="inputEmail4">
                        </div> 
                        <div class="col-12 col-md-6 px-3 pb-3">
