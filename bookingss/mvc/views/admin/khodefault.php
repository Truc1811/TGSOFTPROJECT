...
<form method="post" action="admin/delete">
    <div class="p-6 d-flex justify-content-between align-items-center shadow" style="height:6vh">
        <?php require "mvc/views/plugin/admin/default/top_nhapkho.php"; ?>
    </div>
                                ...
                                foreach($mang as $value){
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-nowrap" scope="row">
                                            <?php echo $value->id_sanpham ?>
                                        </td>
                                        <td class="align-middle text-nowrap" scope="row">
                                            <?php echo $value->name_t ?>
                                        </td>
                                        <td class="align-middle text-nowrap" scope="row">
                                          <?php 
                                          if($value->status==1){
                                    ...
                                    <td class="align-middle text-nowrap" scope="row">
                                        <?php echo $value->so_luong_ton ?>
                                    </td>

                                    <td class="align-middle text-center" scope="row">
                                        <?php require "mvc/views/plugin/admin/default/postupdate.php"; ?>
                                    </td>
