<?php
class gallerymodel extends Controller{
	...
	function add(){
		...
		$mang=array();
		$column='name,khongdau,meta_description,meta_keywords,content,father_level,hide,view,timestamp,image,rank,thuoctinh';
		$va="'$name','$khongdau','$meta_description','$meta_keywords','$content','$father_level','$hide','$view','$timestamp','$image','$rank','$thuoctinh'";
