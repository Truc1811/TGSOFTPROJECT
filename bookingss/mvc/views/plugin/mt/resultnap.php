...
<div class="row padding_tay_1 pt-0 d-flex justify-content-center align-items-center my-5 fs-5">
	...
	<div class="col-12 text-center">
		...
		Lệnh nạp của bạn đã gửi thành công. Hệ thống đang xử lý.
	</div>
	<div class="col-md-12 d-flex justify-content-center" >
		<div class="col-6 p-md-5 rounded-3 mt-3" style="background-color: #F6F4F4;">
