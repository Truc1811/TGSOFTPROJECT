...
<?php
$khoahoc=json_decode($data['khoahoc']);
?>
...
<div class="display_flex_column_m_1 color_den margin_top">
    ...
    <form method="post" action="hoc-vien/ghidanh">
    <div class="display_flex_column_m_1">
          <div class="khung_23">
              ...
              <div class="display_flex_sc">
            	<input type="text" class="input_text" name="name" required="required" />
                <input type="hidden" name="model" value="hocvienmodel" />
              </div>
          </div> 
          <div class="khung_23">
              <div class="display_flex_sc">
              ...
              <div class="display_flex_sc">
            	<input type="text" class="input_text" name="phone" required="required" pattern="[0-9]{10}" 
                title="Vui lòng điền đúng số điện thoại. Có 10 chữ số" />
              </div>
          </div> 
          <div class="khung_23">
              <div class="display_flex_sc">
              ...
              <div class="display_flex_sc">
            	<select class="input_text cursor" name="dangky">
                		<option>
                        	Vui lòng chọn khóa học
                        </option>
                	<?php foreach($khoahoc as $va){ ?>
                    	<option value="<?php echo $va->name; ?>">
                        	<?php echo $va->name; ?>
                        </option>
                    <?php } ?>
                </select>
          ...
          <div class="width_3 display_flex_ec">
          		<div>
          			<input type="submit" class="input_submit" name="bn" value="Đăng Ký" />
            	</div>
          </div> 
  </div>
  </form>
