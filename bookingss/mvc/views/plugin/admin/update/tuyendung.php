...
<div class="col-12 col-md-6 pe-0 pe-md-4 mb-3">
    <label for="hannop" class="form-label">Application deadline <?php echo $dataa[0]->hannop; ?></label>
...
<div class="col-12 pe-0 pe-md-4 mb-3">
    ...
    <textarea id="mota" name="mota" class="form-control"><?php if(@$_POST['mota']){ echo $_POST['mota'];} else { echo $dataa[0]->mota;} ?></textarea>
    <script>CKEDITOR.replace('mota');</script>
</div>
<div class="col-12 pe-0 pe-md-4 mb-3">
    <label for="yeucau" class="form-label">Yêu cầu</label>
    <textarea id="yeucau" name="yeucau" class="form-control"><?php if(@$_POST['yeucau']){ echo $_POST['yeucau'];} else { echo $dataa[0]->yeucau;} ?></textarea>
    <script>CKEDITOR.replace('yeucau');</script>
</div>
<div class="col-12 pe-0 pe-md-4 mb-3">
    <label for="quyenloi" class="form-label">Quyền lợi</label>
    <textarea id="quyenloi" name="quyenloi" class="form-control"><?php if(@$_POST['quyenloi']){ echo $_POST['quyenloi'];} else { echo $dataa[0]->quyenloi;} ?></textarea>
