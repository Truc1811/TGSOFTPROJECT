<style>
  ...
  .tab-scroll-tn-kt::-webkit-scrollbar {
    display: none;
  }
</style>
<?php
...
<div class="p-3">
  ...
  <div class="tab-scroll-tn-kt" style="overflow-y: auto;height:80vh">
    <?php
    foreach ($mang_tinnhan as $key => $valtinnhan) {
    ?>
      <!-- Khách hàng -->
      <div class="customer-card d-flex align-items-start mb-3" style="cursor: pointer;">
        <div class="d-flex align-items-center p-2">
          ...
          <div data-bs-toggle="modal" data-bs-target="#<?php echo $valtinnhan[2]; ?>Modal">
            <!-- Hàng trên: tên + badge gần nhau -->
            <div class="d-flex align-items-center flex-wrap">
              <h6 class="mb-1 fw-bold me-2"><?php echo $valtinnhan[0]; ?></h6>
              <?php if (!empty($valtinnhan[4])): ?>
                <span class="badge bg-danger text-white" style="font-size: 0.75rem;">
                  <?php echo $valtinnhan[4]; ?>
                </span>
              <?php endif; ?>
            </div>
            <!-- Nội dung tin nhắn -->
            <p class="mb-1 text-black-50"><?php echo $valtinnhan[1]; ?></p>
          </div>
        </div>
      </div>
  ...
  ?>
    <!-- Modal -->
    <div class="modal fade mt-4" id="<?php echo $valtinnhan[2]; ?>Modal" tabindex="-1" aria-labelledby="<?php echo $valtinnhan[2]; ?>ModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header bg-primary">
            <h5 class="modal-title text-white" id="<?php echo $valtinnhan[2]; ?>ModalLabel">Chi tiết tin nhắn</h5>
            <div data-bs-dismiss="modal" aria-label="Close" style="cursor:pointer"><i class="bi bi-arrow-left fs-5 text-white"></i></div>
          </div>
          <div class="modal-body">
            <h5 class="mb-3 text-black-50 text-center"><?php echo $valtinnhan[0]; ?></h5>
