 ...
 <div class="container py-3 bg-light d-block d-md-none " style="height: 100vh;">
     <?php require "mvc/views/theme/mau/taikhoan/khachthue/taikhoanmobile/taikhoanmobile.php"; ?>
 </div>
 ...
 <div class="container-fluid d-none d-md-block">
         ...
         <div class="main-header d-flex align-items-center justify-content-between p-3 bg-light">
             <div class="col-12 col-md-6">
                 <div class="d-flex align-items-center">
                     <div class=""><img style="height: 45px;" src="https://phivn.com.vn/public/upload/rvi61688373096.jpg" alt=""></div>
                 </div>
             </div>
             <div class="col-12 col-md-6">
                 <div class="d-flex justify-content-end ">
                     <a class="btn btn-light me-3">Hạng Bạc</a>
                     <a class="btn btn-primary"><?php echo $data['cus_name']; ?></a>
     ...
     <?php
        ...
        $mang_nut_pc_left = [
            ['tinhethong', 'Tin nhắn hệ thống', '<i class="bi bi-chat-dots-fill text-info fs-4"></i>', 'tinhethong', 'show active', 'active'],
            ['tinnhan', 'Tin nhắn', '<i class="bi bi-chat-dots-fill text-info fs-4"></i>', 'tinnhan', '', ''],
            ['taichinh', 'Tài chính', '<i class="bi bi-cash text-info fs-4"></i>', 'taichinh', '', ''],
            ['donhang', 'Đơn hàng', '<i class="bi bi-cash text-info fs-4"></i>', 'donhang', '', ''],
            ['lichsugiaodich', 'Lịch sử giao dịch', '<i class="bi bi-gear-fill text-info fs-4"></i>', 'lichsugiaodich', '', ''],
     ...
     <div class="row">
         <div class="col-3 col-md-2 col-lg-2 col-xl-2">
             <div class="sidebar flex-column tab_scroll_tablet mt-2" style="border-right:2px solid #f1f3f6 ;height:100vh;">
                 <div class="">
                     ...
                     <?php
                        ...
                        ?>
                         <div class="tab-pane fade <?php echo $value[4]; ?>" id="v-pills-<?php echo $value[0]; ?>"
                             ...
                             <?php require "mvc/views/theme/mau/taikhoan/khachthue/taikhoanpc/$value[3].php"; ?>
