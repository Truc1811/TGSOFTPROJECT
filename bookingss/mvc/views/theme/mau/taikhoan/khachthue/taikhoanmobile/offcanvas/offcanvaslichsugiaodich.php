                  ...
                  <tr>
                      <td>
                          <div class="col-12 d-flex d-none">
                              <div class="col-1 fw-bold"><?php echo $mang_lsgdth[0][0] ?></div>
                              <div class="col-2 fw-bold"><?php echo $mang_lsgdth[1][0] ?></div>
                              <div class="col-2 fw-bold"><?php echo $mang_lsgdth[2][0] ?></div>
                              <div class="col-2 fw-bold"><?php echo $mang_lsgdth[3][0] ?></div>
                              <div class="col-2 fw-bold"><?php echo $mang_lsgdth[4][0] ?></div>
                      ...
                      <tr>
                          <td>
                              <div class="col-12 d-flex flex-wrap">
                                  <div class="col-6 fw-bold text-primary"><?php echo $vallsgd[0] ?></div>
                                  <div class="col-6 text-end text-md-start"><?php echo $vallsgd[3] ?></div>
                                  <div class="col-6"><?php echo $vallsgd[1] ?></div>
                                  <div class="col-6  text-end text-md-start"><?php echo $vallsgd[4] ?></div>
                                  <div class="col-6"><?php echo $vallsgd[2] ?></div>
                                  <div class="col-6 text-end text-md-start"><?php echo $vallsgd[5] ?></div>
                                  <div class="col-6 d-none"><?php echo $vallsgd[6] ?></div>
                              </div>
                          </td>
                      </tr>
                  <?php } ?>
