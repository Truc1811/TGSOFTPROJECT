...
<div class="container py-3">
  ...
  <div class="row g-3 d-flex justify-content-center align-items-center">
    ...
    <div class="col-md-6 d-flex flex-column">
        ...
        <a href="https://demob.tgsoft.vn/" class="btn fw-bold fs-5">Quy lại trang chủ</a>
    </div>
...
<!-- Thanh menu dưới -->
<div class="bottom-nav d-md-none d-flex">
  <a href="#" class="active">
    <div><i class="bi bi-house-fill fs-3"></i></div>
    <div>Trang chủ</div>
  </a>
  <a href="#">
    <div><i class="bi bi-chat-fill fs-3"></i></div>
    <div>Tin nhắn</div>
  </a>
  <a href="#">
  ...
  <a href="#">
    <div><i class="bi bi-person-circle fs-3"></i></div>
    <div>Tài khoản</div>
  </a>
</div>
