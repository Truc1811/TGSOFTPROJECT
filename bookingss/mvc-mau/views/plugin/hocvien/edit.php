...
<?php $dataa=json_decode($data['dataa']); ?>
...
<div class="display_flex_column_m_1 color_den margin_top">
    ...
    <form method="post" action="hoc-vien/edit">
        <div class="display_flex_column_m_1">
              <div class="khung_23">
                  ...
                  <div class="display_flex_sc">
                    ...
                    <input type="hidden" value="hocvienmodel" name="model" />
                  </div>
              </div> 
              <div class="khung_23">
                  <div class="display_flex_sc">
              ...
              <div class="width_3 display_flex_ec">
                    <div>
                        <input type="submit" class="input_submit" name="bn" value="Save" />
                    </div>
              </div> 
        </div>
    </form>
