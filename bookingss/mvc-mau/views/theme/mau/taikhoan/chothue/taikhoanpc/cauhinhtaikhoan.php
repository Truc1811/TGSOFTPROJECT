            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body tab-scroll">
                    ...
                    <div class="text-center mb-4">
                        <img src="public/upload/<?php echo $data['cus_image'];  ?>" alt="Avatar" class="rounded-circle mb-2" width="80" height="80">
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="fullname" value="<?php echo $data['cus_name']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label fw-semibold fs-6">Email</label>
                                    <input type="email" class="form-control form-control-sm" id="email" value="<?php echo $data['cus_email']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="phone" class="form-label fw-semibold fs-6">Số điện thoại</label>
                                    <input type="tel" class="form-control form-control-sm" id="phone" value="<?php echo $data['cus_phone']; ?>">
                                </div>
                            </div>
