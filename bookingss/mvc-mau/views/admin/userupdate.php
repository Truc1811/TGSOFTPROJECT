                ...
                <div class="col-12 d-flex flex-wrap p-2">
                    <div class="col-12 bg-white rounded-3 d-flex flex-wrap">
                        ...
                        <div class="col-12 col-md-6 px-3 pb-3">
                            ...
                            <input type="text" name="user" required="required" class="form-control form-control-sm" id="inputEmail4"
                                value="<?php if(@$_POST['user']){ echo $_POST['user'];} else { echo $dataa[0]->user;} ?>"
                            >
                        </div>
                        <div class="col-12 col-md-6 px-3 pb-3">
                            <label for="inputEmail4" class="form-label" >password</label>
                            <input type="text" name="password" required="required" class="form-control form-control-sm" id="inputEmail4"
                        ...
                        <div class="col-12 col-md-6 px-3 pb-3">
                            ...
                            <input type="text" name="role" required="required" class="form-control form-control-sm" id="inputEmail4"
                                value="<?php if(@$_POST['role']){ echo $_POST['role'];} else { echo $dataa[0]->role;} ?>"
                            >
                        </div>
                        <div class="col-12 col-md-6 px-3 pb-3">
